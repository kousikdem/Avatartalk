 ...
 * Returns: {
 *   success: true,
 *   order_id, amount, currency, key_id, tokens, purchase_id
 * }
 */
...
const MIN_AMOUNT_INR = 99; // Razorpay minimum
...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  // Persist a pending purchase row so verify can credit tokens later
