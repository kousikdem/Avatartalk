...
const VirtualCollaborationPage = () => {
  ...
  const handleConnectGoogle = async () => {
    toast({
      ...
      description: "Google Meet & Calendar integration requires OAuth setup. Contact admin to configure.",
    });
  };
  ...
  const handleConnectZoom = async () => {
    toast({
      title: "Connect Zoom",
      description: "Zoom integration requires OAuth setup. Contact admin to configure.",
    });
  };
          ...
          <CardContent className="p-4">
            <div className="flex flex-wrap items-center justify-between gap-4">
              ...
              <div className="flex flex-wrap gap-3">
                {/* Google Connect */}
                <Button
                  variant={integrations?.google_connected ? "secondary" : "outline"}
                  size="sm"
