    ...
    <Dialog open={isOpen} onOpenChange={() => onClose()}>
      <DialogContent className="sm:max-w-md bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 border border-blue-500/30 backdrop-blur-xl text-white">
        ...
        <div className="flex gap-2">
          <Button 
            variant="outline" 
            className="flex-1 bg-[#1877F2]/20 border border-[#1877F2]/50 text-white hover:bg-[#1877F2]/40 flex items-center justify-center gap-2 py-2"
          ...
          <Button 
            variant="outline" 
            className="flex-1 bg-black/20 border border-white/30 text-white hover:bg-black/40 flex items-center justify-center gap-2 py-2"
          ...
          <Button 
            variant="outline" 
            className="flex-1 bg-[#0A66C2]/20 border border-[#0A66C2]/50 text-white hover:bg-[#0A66C2]/40 flex items-center justify-center gap-2 py-2"
